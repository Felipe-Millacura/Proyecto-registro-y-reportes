<?php
	...
	if(isset($_POST['btnGrabar']) && $_POST['btnGrabar']) // BOTÓN PRESIONADO
	{
		...
		else
		{
			...
			$persona->setIdSucursal($_POST['cmbSucursal']);
			...
			{
				/* Se transfiere archivo al servidor */
	...
	$js = "Persona.js"; // es el archivo js para esta página
...
?>
	<form action=Persona.php method=post enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-12 divFoto">
				Foto
			</div>
			<div class="col-12 divFoto">
				<input type=file name=txtFoto class="txtFoto form-control">
			</div>	
			<div class="col-2 divFotoCandidato">
