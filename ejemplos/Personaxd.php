...
class Persona implements IOperaciones
{
	...
	function grabar()
	{
		if($this->id > 0)
			...
			$sql = "INSERT INTO Persona VALUES (NULL, '$this->idSucursal','$this->rut', '$this->digito','$this->nombre', '$this->apellido','$this->esCandidato', '$this->urlFoto')";
