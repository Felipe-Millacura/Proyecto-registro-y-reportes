...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'Ventas totales por sucursal',0,0,'C');
    // Salto de línea
    $this->Ln(20);

    $this->cell(75, 10,'Nombre de sucursal',1,0,'C',0);
...
$consulta = "SELECT u.nombre,count(b.idboleta)
from sucursal u 
